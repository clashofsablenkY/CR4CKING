...
print('[1] Minta Lisensi')
print('[2] Masukan Masukan Lisensi')
print('[3] Keluar {U}[{H}Exit{U}]{H}')
#line:49
    OOO00O0OOO00OO00O =input (f"{H}[{P}?{H}]{P} ===> Pilih :{K} ")#line:50
    if OOO00O0OOO00OO00O in ['1','01']:#line:51
      print (f"{H}[{P}!{H}]{P} Anda Akan Diarahkan Ke Whatsapp...");time .sleep (3 );os .system ('xdg-open https://wa.me/6283840773162?text=Haii+Nurhana+Cantik+Bagi+Lisensi+nya+dong.......???????');exit ()#line:52
